    ...
    if(httpCode > 0) {
      ...
      if(httpCode == HTTP_CODE_OK) {
        ...
        if (JSONerr) {   //Check for errors in parsing
          ...
          M5.Lcd.setTextColor(TFT_WHITE, TFT_BLACK);
          M5.Lcd.fillRect(106,0,48,24,TFT_BLACK);
          ...
          */
          ...
          strcpy(NSurl,"https://");
          strcat(NSurl,cfg.url);
          strcat(NSurl,"/api/v1/devicestatus.json?count=1");
          http.begin(NSurl); //HTTP
          ...
          if(httpCode > 0) {
            ...
            if(httpCode == HTTP_CODE_OK) {
              ...
              if (JSONerr) {   //Check for errors in parsing
                ...
                M5.Lcd.fillRect(106,24,36,24,TFT_BLACK);
                ...
                M5.Lcd.fillRect(106,48,36,24,TFT_BLACK);
                ...
                M5.Lcd.fillRect(106,72,36,24,TFT_BLACK);
